            ...
            <div className="grid grid-cols-12 gap-2 items-start">
                ...
                <div className="col-span-1 flex justify-center pt-1 gap-1">
                    {onMove && typeof index === 'number' && typeof total === 'number' && (
                        <>
                            <Button size="xs" variant="ghost" onClick={() => onMove('up')} disabled={index === 0} className="w-6 h-8 text-gray-400 hover:text-[var(--theme-primary)] hover:bg-gray-100 disabled:opacity-30"><Icon icon="fa-solid fa-arrow-up" /></Button>
                            <Button size="xs" variant="ghost" onClick={() => onMove('down')} disabled={index === total - 1} className="w-6 h-8 text-gray-400 hover:text-[var(--theme-primary)] hover:bg-gray-100 disabled:opacity-30"><Icon icon="fa-solid fa-arrow-down" /></Button>
                        </>
                    )}
                    <Button size="xs" variant="ghost" onClick={onDelete} className="w-8 h-8 text-red-400 hover:text-red-600 hover:bg-red-50"><Icon icon="fa-solid fa-trash" /></Button>
                </div>
            </div>
